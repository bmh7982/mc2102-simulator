...
//const int DIMMING[] = {56, 52, 48, 44, 40, 16, 8, 4};	//Dimming Pulse - �տ��� ���� ��� ���� ��.
const int DIMMING[] = {4, 8, 16, 40, 44, 48, 52, 56};	//Dimming Pulse - �տ��� ���� ��� ���� ��.
...
/*			if((ADDR[7] & 0x01) == 0x01){}
		...
		if(Dimming_cnt>56){Dimming_cnt=0;}		//Dimming cnt �ʱ�ȭ
	}
}
...
void proc(void){
	...
	if(b_stb==1){
		...
		*/
		...
		#define CMD_TYPE_DISPLAY  0x00
		#define CMD_TYPE_CTRL     0x40
		#define CMD_TYPE_ADDR     0xC0
		#define CMD_TYPE_DIMMING  0x80
		switch(command & CMD_TYPE_MASK){
			case CMD_TYPE_DISPLAY: command1(); break;
			case CMD_TYPE_CTRL:    command2(); break;
			case CMD_TYPE_DIMMING: command4(); break;
			case CMD_TYPE_ADDR:    command3(); break;
		}
