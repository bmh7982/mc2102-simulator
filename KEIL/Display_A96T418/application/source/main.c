...
// interrupt routines
//======================================================
//CLK PIN --> STB�� LOW �� �� DIN, OUT �ϴ� ����
//DIN�� ���� CLK�� HIGH �� �� �ϴ� ���̰�, DOUT�� CLK�� LOW�� �� �ϴ� ����.
		...
		if(wrmode == WRITE_MODE){
			if(IS_CLK()){
				...
				if(DataINcnt >= 8){
					DataINcnt = 0;
					DIN[dincnt] = DataIN;
					dincnt++;    //26.02.11 dincnt�� over flow�� ���ɼ��� ������ ��
					DataIN = 0;
				}
			}
		}
...
//Display Dimming
#define TIMER1_10US_COUNT 0x9F  // 16MHz / (10us * prescaler)
void Timer1_init()
{
	// initialize Timer
